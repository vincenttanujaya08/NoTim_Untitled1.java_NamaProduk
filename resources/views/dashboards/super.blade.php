...
<body class="bg-gray-100">
    <div class="max-w-7xl mx-auto p-4 space-y-8">
        ...
        {{-- Header --}}
        <h1 class="text-3xl font-semibold text-gray-800">Dashboard Super Admin</h1>
        ...
        {{-- Stok Global per Komoditas (Horizontal Scroll) --}}
        ...
        <div class="bg-white rounded-lg shadow p-5">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('cooperatives.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Tambah Koperasi</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                ...
                                <form action="{{ route('cooperatives.destroy', $coop->id) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button class="text-red-600 hover:text-red-800" onclick="return confirm('Yakin ingin hapus?')">Hapus</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
        ...
        <form method="POST" action="{{ route('logout') }}" class="text-center">
            @csrf
            <button type="submit" class="bg-gray-800 text-white px-6 py-2 rounded hover:bg-gray-900">Logout</button>
        </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const input = document.getElementById('commoditySearch');
